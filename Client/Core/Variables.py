...
CERTIFICATE_PATH = os.path.abspath(os.path.join(BASE_DIR, '..'))
cert_path = os.path.join(CERTIFICATE_PATH, 'cert.pem')

####################################################################################################################

c2_ip = "13.62.51.197"
c2_server = f"https://{c2_ip}:5000"
rsa_key = "private.pem"
...
extesions = ['.test'] # This one is just for testing
